...
const Header = ({ scrollBackwards, setScrollBackwards }) => {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if (currentScroll === 0) {
                setScrollBackwards(false);
            } else if (currentScroll < prevScroll) {
                setScrollBackwards(true);
            } else {
                setScrollBackwards(false);
            }
    ...
    return (
        <section>
            <header>
                <div className="max-w-[1440px] mx-auto px-6 mt-0 min-[770px]:mt-6">
